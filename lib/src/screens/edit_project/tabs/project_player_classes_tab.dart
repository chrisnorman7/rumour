        ...
        itemBuilder: (final context, final index) {
          ...
          return PerformableActionsListTile(
            ...
            onTap: () => context.pushWidgetBuilder(
              (final _) => EditPlayerClassScreen(playerClassId: playerClass.id),
            ),
          );
        },
